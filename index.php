...
<div class="global">
    ...
    <form enctype="multipart/form-data" method="post" action="">
        ...
        <table width="100%">
            <td width="50%">
                <p><input name="language" type="radio"
                          value="rus" <?php if (isset($_POST['language'])) echo ($_POST['language'] == 'rus') ? 'checked' : ''; ?>>
                    Морзе-Рус</p>
                <p><input name="language" type="radio"
                          value="eng" <?php if (isset($_POST['language'])) echo ($_POST['language'] == 'eng') ? 'checked' : ''; ?>>
                    Морзе-Анг</p>
                <p><input name="language" type="radio"
                          value="bel" <?php if (isset($_POST['language'])) echo ($_POST['language'] == 'bel') ? 'checked' : ''; ?>>
                    Морзе-Бел</p>
                <p><input name="language" type="radio"
                          value="mor" <?php if (isset($_POST['language'])) echo ($_POST['language'] == 'mor') ? 'checked' : ''; else echo 'checked'; ?>>
                    Текст-Морзе</p>
            ...
            <td width="50%">
                ...
                if (isset($_POST['mainButton']) && file_exists('cache/out/' . $MorseCodeConverter->getFilePath())) {
                    ...
                    <p>
                        ...
                        <audio controls>
                            <source src="<?php echo 'cache/out/' . $MorseCodeConverter->getFilePath(); ?>"
                                    type="audio/wav"/>
                            Your browser does not support the audio element.
                        </audio>
                    <p>or <a type="audio/wav" href="<?php echo 'cache/out/' . $MorseCodeConverter->getFilePath(); ?>"
                             download>
    ...
    <h2 class="sub-caption-smaller">Our other prototypes are here: <a href="../">www.corpus.by</a>, <a
            href="http://ssrlab.by">www.ssrlab.by</a>.</h2>
    <div class="footer">
